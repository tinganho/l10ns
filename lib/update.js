...
Update.prototype._mergeTranslations = function(newTranslations, callback) {
  ...
  this.mergeUserInputs(_newTranslations, oldTranslations, function(err, _newTranslations) {
    if(!err) {
 ...
 *
 * @param {struct} newTranslations
 * @param {struct} oldTranslations
 *
 * @return deletedTranslations {struct}
 *
 *   Returns:
 *     {
 *       TRANSLATION_KEY1 : {
