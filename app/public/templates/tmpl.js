...
var out='<div class="search-result"><ul class="search-result-list">';var arr1=it.results;if(arr1){var result,index=-1,l1=arr1.length-1;while(index<l1){result=arr1[index+=1];out+='<li class="search-result-item"><span class="search-result-item-text">'+(result.get('key'))+'</span></li>';} } out+='</ul></div>';return out;
};
