...
var out='<div class="search"><div class="search-input-container"><input class="search-input" type="text" placeholder="Search"></input></div></div>';return out;
};
...
var out='<tr class="translations-edit-row" data-id="'+(it.id)+'"><td class="translations-edit-cell" colspan="2"></td></tr>';return out;
 ...
 tmpl['translationsRegions']=function anonymous(it) {
