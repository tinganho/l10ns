...
var out='<div class="translation"><div class="translation-blur-helper"><h1 class="translation-key">'+(it.key)+'</h1><div class="translation-body"><ul class="translation-vars"><li class="translation-header">VARIABLES</li><li class="translation-var"><ul class="translation-vars-vars">';if(it.vars.length != 0){var arr1=it.vars;if(arr1){var value,index=-1,l1=arr1.length-1;while(index<l1){value=arr1[index+=1];out+='<li class="translation-vars-var">'+(value)+'</li>';} } }else{out+='<li class="translation-vars-var">None</li>';}out+='</ul></li></ul><ul class="translation-values"><li class="translation-header">ENGLISH</li><li class="translation-form"><form><div class="translation-input-helper"><input class="translation-input js-translation-input"type="text"value="';if(it.type === 'simple'){out+=(it.value.value);}out+='"></input></div><div class="translation-button-container"><div class="js-translation-else white-button"><a>ELSE</a></div><input class="translation-save js-translation-save form-submit" type="submit" value="SAVE"></input></div></form></li></ul></div></div><div class="translation-loading-frame"><div class="translation-loading-container"><div class="translation-loading-indicator-helper"><i class="translation-loading-indicator"></i></div><span class="translation-loading-text">SAVING...</span></div></div></div>';return out;
};
...
var out='<ul class="translation-values"><li class="translation-header">ENGLISH</li><li class="translation-form"><form><div class="translation-input-helper"><input class="translation-input js-translation-input"type="text"value="';if(it.type === 'simple'){out+=(it.value.value);}out+='"></input></div><div class="translation-button-container"><div class="js-translation-else white-button"><a>ELSE</a></div><input class="translation-save js-translation-save form-submit" type="submit" value="SAVE"></input></div></form></li></ul>';return out;
};
