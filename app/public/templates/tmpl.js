...
var out='<div class="search-no-result bg-dark-grey"><span class="search-no-result-text">No result of "'+(it.query)+'"</span><span class="search-no-result-back js-search-no-result-back">Back to latest translations</span></div>';return out;
};
